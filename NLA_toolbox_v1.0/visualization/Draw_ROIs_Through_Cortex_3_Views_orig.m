...
subplot(1,3,1,'Position',[0.14,0.1,0.24,0.84])  % Posterior View [left,bottom,w,h]
Draw_ROIs_Through_Cortex(Anat,roi,Conn,params);
view([0,0])
subplot(1,3,2,'Position',[0.4,0.1,0.22,0.82])  % Dorsal View
Draw_ROIs_Through_Cortex(Anat,roi,Conn,params);
view([0,90])
% title(params.group{g})
subplot(1,3,3,'Position',[0.64,0.08,0.27,0.87])  % Left Lateral View
Draw_ROIs_Through_Cortex(Anat,roi,Conn,params);
view([-90,0])
